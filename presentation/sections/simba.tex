...
\begin{frame}{\insertsubsection}{Plate notation}
	\begin{columns}
		\begin{column}{0.45\textwidth}
			\begin{figure}
				\resizebox{\textwidth}{!}{%
				\input{figures/vertical_plate.tex}
			}
		...
		\begin{column}{0.45\textwidth}
			\begin{figure}
				\resizebox{\textwidth}{!}{%
					\input{../figures/author_plate.tex}
				}
...
\begin{frame}{\insertsubsection}{Plate notation}
		...
		\begin{column}{0.38\textwidth}
			\begin{figure}
				\resizebox{\textwidth}{!}{%
					\input{figures/mini_vertical_plate.tex}
				}
				\caption*{The LDA model}
			\end{figure}
		\end{column}
		\begin{column}{0.52\textwidth}
			\begin{figure}
				\resizebox{\textwidth}{!}{%
					\input{figures/mini_author_plate.tex}
				}
				\caption*{The author-topic model}
			\end{figure}
		\end{column}
...
\begin{frame}{\insertsubsection}{Plate notation}
	\begin{columns}
		...
		\begin{column}{0.45\textwidth}
			\begin{figure}
				\resizebox{\textwidth}{!}{%
					\input{figures/mini_category_plate.tex}
				}
