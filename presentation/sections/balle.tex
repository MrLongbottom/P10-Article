...
\begin{frame}{\insertsection}{Problems}
	Features needed:
	\begin{itemize}
...
\begin{frame}{\insertsection}{Doc-Author \& Doc-Category Models}
	\begin{table}
		\centering
		\begin{tabular}{l|c|c}
...
\begin{frame}{\insertsection}{Author-\acrshort{pam} \& Category-\acrshort{pam} Models}
