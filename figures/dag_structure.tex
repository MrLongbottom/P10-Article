\begin{figure}[h]
	...
	\begin{tikzpicture}
		...
		\node (root) [unobserved, node distance=1.9cm] at (7,0) {};
		\node (rootname) [right of = root, node distance=2.5cm] {Root};
		
		\node (first) [observed, below of=root, node distance=1.9cm] {};
		\node (firstname) [right of = first, node distance=2.5cm] {STEDER};
		
		\node (second) [observed, below of=first, node distance=1.9cm] {};
		\node (secondname) [right of = second, node distance=2.5cm] {Danmark};
		
		\node (third) [unobserved, below of=second, node distance=1.9cm] {};
		\node (thirdname) [right of = third, node distance=2.5cm] {Sports rootic};
		
		\node (fourth) [unobserved, below of=third, node distance=1.9cm] {};
