\begin{tikzpicture}
	...
	\node (theta_r) [unobserved, above of= z-2, node distance=2cm] {$\theta_a^d$};
	\node (alpha_r) [unobserved, above of= theta_r , node distance=2cm] {$\alpha_a$};
	
	\node (theta_k) [unobserved, above of= z-3, node distance=2cm] {$\theta_b^d$};
	\node (alpha_k) [unobserved, above of= theta_k , node distance=2cm] {$\alpha_b$};
	
	\node (theta_s2) [unobserved, left of=w-j , node distance=6cm] {$\theta_b$};
