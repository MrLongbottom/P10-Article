\begin{tikzpicture}
	...
	\node (theta_a) [unobserved, above of= z-2, node distance=2cm] {$\theta_r^d$};
	\node (alpha_a) [unobserved, above of= theta_a , node distance=2cm] {$\alpha_r$};
	
	\node (theta_b) [unobserved, above of= z-3, node distance=2cm] {$\theta_{t}^d$};
	\node (alpha_b) [unobserved, above of= theta_b , node distance=2cm] {$\alpha_{t}$};
	
	\node (theta_c) [unobserved, above of= z-4, node distance=2cm] {$\theta_{t}^d$};
	\node (alpha_c) [unobserved, above of= theta_c , node distance=2cm] {$\alpha_{t}$};
