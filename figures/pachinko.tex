\begin{figure}[h]
	...
	\begin{tikzpicture}
		...
		\node (theta_k) [unobserved, above of= z-3, node distance=2cm] {$\theta_k^d$};
		\node (alpha_k) [unobserved, above of= theta_k , node distance=2cm] {$\alpha_k$};
		
		\node (theta_b) [unobserved, above of= z-4, node distance=2cm] {$\theta_b^d$};
		\node (alpha_b) [unobserved, above of= theta_b , node distance=2cm] {$\alpha_b$};
		
		\node (theta_s2) [unobserved, left of=w-j , node distance=8cm] {$\theta_b$};
