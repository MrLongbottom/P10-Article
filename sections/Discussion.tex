...
Before investigating the article below, we define a specific color scheme for each model, seen in \autoref{tab:disc_color}.

In the article in \autoref{fig:the_article}, we have highlighted the highest probable words within the three most occurring topics in the article.
...
\input{sections/discussion/taxonomy-topic.tex}
