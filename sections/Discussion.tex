...
In \autoref{tab:top_words_three_models}, we can see that there is not many top words in the Author-topic and Category-Topic model that appear in the article below.
