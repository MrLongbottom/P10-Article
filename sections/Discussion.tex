...
Another aspect of the Author-Topic model is that the authors writing these articles might not be specifically writing about a certain subject, which explains why there is only three not important words marked here. 
