...
Just at for the author-topic model, the similarity between pairs of categories can be calculated.
...
It is also clear that some of the topics, the model have learned, fit well with how some categories are used in the dataset.
