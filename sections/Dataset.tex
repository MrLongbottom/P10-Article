...
This field is only partially observed within the dataset, which means that ${\sim}25\%$ of the articles containing this field.
It is also possible for articles to contain multiple taxonomies sequences.
