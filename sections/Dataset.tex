...
\todo[inline]{This line can probably be cut, since it doesn't seem to give anything new compared to the subsection below.}
...
\autoref{fig:category_box} shows an overview of the size of the categories after filtering.\langballe[inline]{consider showing name of categories and relvative dataset size.}
...
\todo[inline]{What is specifically meant by 'variable'? Is it the same as the field, or something else?}
