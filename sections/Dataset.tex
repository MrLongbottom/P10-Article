...
There were originally $227$ different authors within the dataset.
After filtering away authors that have written less that $14$ documents ($\tilde0.001\%$ of the total document set), 184 remain.
...
Originally there were $1135$ different taxonomies, however after removing taxonomies used by less tham $4$ documents ($\tilde 0.01\%$ of the amount of documents with taxonomies), $613$ remain.
