...
Originally there were $1135$ different taxonomies however after removing taxonomies used by less than $4$ documents ($\tilde 0.01\%$ of the number of documents with taxonomies), $613$ remain.
