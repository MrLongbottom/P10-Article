...
Multiple approaches have been proposed to improve the incorporation of metadata, but tailoring the models to benefit from the existing metadata can be a difficult task.
