...
\vejleder[inline]{se thomas dokument}
\begin{enumerate}
...
\vejleder[inline]{beskriv gibbs sampling i appendix}
...
Without modification, \gls{pam} will find topics with the same structure as our taxonomy, but the topics will not actually be based on the taxonomy.\vejleder[inline]{hvad vil det sige?}
