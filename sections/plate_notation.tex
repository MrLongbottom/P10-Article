...
\begin{align*}
	...
	\frac{n_{1r}^d + \alpha_{1r}}{n_1^d + \sum_{r'} \alpha_{1r'}} \times
	\frac{n_{rk}^d + \alpha_{rk}}{n_r^d + \sum_{k'} \alpha_{rk'}}  \times 
	\frac{n_{kb}^d + \alpha_{kb}}{n_{k}^d + \sum_{b'} \alpha_{kb'}} \\ \times 
	\frac{n_{bw}^d + \beta_{w}}{n_{b} + \sum_{m} \beta_{m}} 
\end{align*}
