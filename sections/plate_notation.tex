...
The \gls{dag} structure represents topics which in pachinko allocation are distributions over words and/or other topics further down in the \gls{dag} structure, rather than distribution only over words as with \gls{lda}.
...
We therefore also limit the taxonomy dataset to the only first $3$ taxonomy entries for each document, to fit with our \gls{dag} structure.
