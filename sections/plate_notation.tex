...
We find this model structure to be generally applicable to most metadata information, 
assuming that the metadata has influence on the text of the document or that the text of the document has influence on the metadata.
The author metadata has influence on the text of the documents, as each author has their own writing style and subjects they write about.
The text of the documents has influence on the category metadata, as it is assumed that the category is chosen after the document has been written.
