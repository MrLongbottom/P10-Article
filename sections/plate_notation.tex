\section{Plate Notation}\label{sec:plate_notation}
...
\todo[inline]{Expand this. Also include description of the assumed generative process that made the documents (which should probably also be expanded with the other models).}
