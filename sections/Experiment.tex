...
Each value is between $-1$ and $1$, with $-1$ meaning that the words never occour together and 1 meaning that they only occour together.
...
\end{equation}
\noindent where gamma can be used to further prioritize higher values. For this paper we use $\gamma = 1$, as recommended by \citet{Syed2017coherence}.
