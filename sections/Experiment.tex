...
This metric gives an indication of how coherent topics are, and will be an indication of the quality of the topics a topic model generates.\todo{Source, probably tea leaves}
