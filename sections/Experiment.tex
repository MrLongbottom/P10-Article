...
Before calculating word probabilities, a sliding window of size $s$ where $s =110$ \vejleder[inline]{how are parameters chosen} is used to create a set of subdocuments $D_s$ over the document set $D$.
