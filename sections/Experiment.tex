...
After having calculated the \gls{npmi} matrix, we construct context vectors for both element $W'$ and $W*$ in each word-pair $S_i$, by summing over the rows of the \gls{npmi} matrix.
