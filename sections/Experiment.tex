...
This metric gives an indication of how coherent topics are, and will be an indication of the quality of the topics a topic model generates.\todo{Source}
...
To evaluate the \gls{lda} model, we measure the topic coherence of the model after training it on the dataset\todo{all data or training dataset?} for ?? epochs.
