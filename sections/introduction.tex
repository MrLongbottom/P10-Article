...
However, \citet{MetaLDA2017} learn a specific Dirichlet prior over the topics based on the meta information given in their dataset, which gives a specific topic distribution for each meta information field and in turn affect the document topic distribution used with the \gls{lda}.
...
We would like to see what happens when you create a meta-topic distribution for any specific meta information, like author, and see how it affect the resulting topics.
The intuition behind this is to create new topic models, which describe the data in a different way using topics like meta data describe something about locations we can find location specific topics.
