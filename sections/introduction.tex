...
Broadcasting information around the world is a crucial skill, that is used every day, like news articles, television and newspapers supply people with the latest information.
Searching and categorizing the news is becoming a bigger problem since the news is created every day, if not every hour.
As the internet, becomes more personalized, like a targeted advertisement, recommendation is seeing more use in applications, such as Netflix and Amazon.
...
One particular field, which covers a variety of different use cases and applications in the field of topic modeling.
Topic modeling has been used for finding topics within a collection of documents, to either annotate or categorize certain collections of texts\cite{red_article_blei}.   
