...
Topic modeling is an approach that takes a set of documents and generates topics that can be used for categorizing text, such as news articles.

One particular field, which covers a variety of different use cases and applications, such as being useful for recommendations, is the field of topic modeling. \vejleder{gerne mere skarp i forhold til anbefalinger}
...
The \gls{lda} model is a well-cited topic model which generates topics and topic distributions for documents based on the words in documents~\cite{blei2003latent}.
