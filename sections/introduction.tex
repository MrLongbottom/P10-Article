...
\vejleder[inline]{what cant they do? what are the weaknesses? this will sharpen the part about our work.}
...
\vejleder[inline]{skriv introduktionen frem til dette punkt mere sammen}
...
\end{itemize}
\vejleder[inline]{it sound like the related work already does this}
...
In \autoref{sec:plate_notation}, \gls{lda}, the metadata topic models, and the model combinations are described, and their plate notation is shown.\vejleder{why not not have this section after overview?}
