...
However, the dataset that will form this corpus also often includes with various other data than just the text within the documents, such as authors, time stamps, tags, etc.
% Metadata definition
