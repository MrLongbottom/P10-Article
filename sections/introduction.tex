...
% Intro to meta data
Data is everywhere and its used in many different scenarios and use cases. 
When referring to a data set, we talk about a data having meta-data information or attributes, which is the entries that could describe certain features about the data, like petal length from well known IRIS data set\footnote{https://archive.ics.uci.edu/ml/datasets/iris} describing the length of a particular flowers petals.
