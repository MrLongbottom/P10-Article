...
We have created a combination model, as an extension of our metadata models, to see whether using multiple metadata types at the same time to draw topics, would affect the performance of the topic model.
