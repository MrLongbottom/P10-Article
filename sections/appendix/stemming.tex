...
There is most likely fewer articles, because when we filter words that appear in more than $10\%$ of the documents after stemming, some new documents may end up empty.
...
From experience, POS taggers can not figure out the semantic meaning of words that are spelled the same, and then we would somehow have to chose which meaning is correct, possibly creating new errors in our data.
