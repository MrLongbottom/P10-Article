...
In this project, we have done minimal preprocessing \vejleder[inline]{hvad med ?? ord (se dokument)}of the dataset, because, in a previous project, a more aggressive preprocessing step turned out to hurt the performance of the \gls{lda} model.
