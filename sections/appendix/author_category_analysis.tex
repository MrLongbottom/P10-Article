...
While modeling single metadata is the main focus of this paper, looking at the results of models combining multiple metadata may also bring new observations.
For this purpose, we will be examining the results of the Author-Category \gls{lda}.
