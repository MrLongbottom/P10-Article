...
As mentioned in \autoref{sec:dataset}, there are some nonsensical categories that are worth mentioning.
...
By looking at a random selection of documents from these categories, there can not be seen any pattern of topics.
The topics written can be about anything from sports to news from around the world or locally in Denmark.
All articles seem to be from 2019, the last year in our dataset, but spread over the whole year.
...
We continue to use these categories in our experiment, because we might make other observations through the topic models.
