...
Instead, the vast majority of the values fall in a lower range, meaning that setting the threshold too high will result in removing a large portion of the data.
...
Other than the 'System Administrator' author, there are a few other authors that seem different since they do not have the name of a person.
