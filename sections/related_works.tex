...
From these works, we adapt the concepts from \citet{author_topic_2012}\vejleder{argument ad fra data + formål} for how we use metadata in our models, though with slight changes in the models for handling the characteristics of our data.
